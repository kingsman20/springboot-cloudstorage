...
class CloudStorageApplicationTests {
	...
	public void noteCreationTest() {
		...
		WebElement noteSubmit = driver.findElement(By.id("btnNoteSubmit"));
		wait.until(ExpectedConditions.elementToBeClickable(noteSubmit)).click();
		Assertions.assertEquals("Home", driver.getTitle());
	...
	public void credentialCreationTest() {
		...
		wait.withTimeout(Duration.ofSeconds(30));
		WebElement newCred = driver.findElement(By.id("btnAddCred"));
